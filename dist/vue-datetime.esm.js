...
function hourIsDisabled (allowedDateTimeRanges, currentDateTime, hour) {
  var startCheck = DateTime.fromObject({ year: currentDateTime.c.year, month: currentDateTime.c.month, day: currentDateTime.c.day, hour: hour, zone: 'UTC' });
...
function minuteIsDisabled (allowedDateTimeRanges, currentDateTime, hour, minute) {
  var startCheck = DateTime.fromObject({ year: currentDateTime.c.year, month: currentDateTime.c.month, day: currentDateTime.c.day, hour: hour, minute: minute, zone: 'UTC' });
