...
function getDateFromDateTime (dateTime, dateModification) {
  ...
  dateModification.map(function (option) { dateTimeOpts[option] = dateTime.c[option]; });
  return luxon.DateTime.fromObject(dateTimeOpts)
}

function checkAllowedDateTimeRanges (allowedDateTimeRanges, startCheck, endCheck, dateModification) {
  if ( endCheck === void 0 ) endCheck = null;
  ...
  return allowedDateTimeRanges && (allowedDateTimeRanges.length > 0) &&
    ...
    !allowedDateTimeRanges.find(function (ref) {
      var allowedStartDate = ref[0];
      var allowedEndDate = ref[1];
...
function monthDayIsDisabled (allowedDateTimeRanges, year, month, day) {
  return checkAllowedDateTimeRanges(allowedDateTimeRanges, luxon.DateTime.fromObject({ year: year, month: month, day: day, zone: 'UTC' }))
}

function monthIsDisabled (allowedDateTimeRanges, year, month) {
  return checkAllowedDateTimeRanges(
    allowedDateTimeRanges,
    luxon.DateTime.utc(year, month, luxon.DateTime.utc(year, month).daysInMonth),
    luxon.DateTime.utc(year, month, 1)
  )
}

function yearIsDisabled (allowedDateTimeRanges, year) {
  return checkAllowedDateTimeRanges(allowedDateTimeRanges, luxon.DateTime.utc(year))
}

function hourIsDisabled (allowedDateTimeRanges, currentDateTime, hour) {
  var startCheck = luxon.DateTime.fromObject({ year: currentDateTime.c.year, month: currentDateTime.c.month, day: currentDateTime.c.day, hour: hour });
  var dateTimeModification = ['year', 'month', 'day', 'hour'];
  return checkAllowedDateTimeRanges(allowedDateTimeRanges, startCheck, null, dateTimeModification)
}

function minuteIsDisabled (allowedDateTimeRanges, currentDateTime, hour, minute) {
  var startCheck = luxon.DateTime.fromObject({ year: currentDateTime.c.year, month: currentDateTime.c.month, day: currentDateTime.c.day, hour: hour, minute: minute });
  var dateTimeModification = ['year', 'month', 'day', 'hour', 'minute'];
  return checkAllowedDateTimeRanges(allowedDateTimeRanges, startCheck, null, dateTimeModification)
}

function selectionIsDisabled (hours, use12Hour, selection) {
  // if not use12hours
  var enabledHours = hours.filter(function (hour) { return !hour.disabled; });
  var hasSelection = enabledHours.length > 0;
  if (use12Hour) {
    hasSelection = !!enabledHours.find(function (hour) { return selection === 'am' ? hour.number < 12 : hour.number >= 12; }
    );
  }
  return !hasSelection
}
...
function getAllowedDateTimeRanges (allowedDateTimeRanges, min, max) {
  if (!allowedDateTimeRanges.length) {
    ...
    if (min && max) {
      ...
      minMaxArray.push(min);
      minMaxArray.push(luxon.DateTime.fromFormat('31-12-3000 23:59:59', 'dd-MM-y hh:mm:ss'));
    } else if (max) {
      minMaxArray.push(luxon.DateTime.fromFormat('01-01-1972 00:00:00', 'dd-MM-y hh:mm:ss'));
      minMaxArray.push(max);
    }
...
var DatetimeCalendar = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vdatetime-calendar"},[_c('div',{staticClass:"vdatetime-calendar__navigation"},[_c('div',{staticClass:"vdatetime-calendar__navigation--previous",on:{"click":_vm.previousMonth}},[_c('svg',{attrs:{"xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 61.3 102.8"}},[_c('path',{attrs:{"fill":"none","stroke":"#444","stroke-width":"14","stroke-miterlimit":"10","d":"M56.3 97.8L9.9 51.4 56.3 5"}})])]),_vm._v(" "),_c('div',{staticClass:"vdatetime-calendar__current--month"},[_vm._v(_vm._s(_vm.monthName)+" "+_vm._s(_vm.newYear))]),_vm._v(" "),_c('div',{staticClass:"vdatetime-calendar__navigation--next",on:{"click":_vm.nextMonth}},[_c('svg',{attrs:{"xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 61.3 102.8"}},[_c('path',{attrs:{"fill":"none","stroke":"#444","stroke-width":"14","stroke-miterlimit":"10","d":"M56.3 97.8L9.9 51.4 56.3 5"}})])])]),_vm._v(" "),_c('div',{staticClass:"vdatetime-calendar__month"},[_vm._l((_vm.weekdays),function(weekday){return _c('div',{staticClass:"vdatetime-calendar__month__weekday"},[_vm._v(_vm._s(weekday))])}),_vm._v(" "),_vm._l((_vm.days),function(day){return _c('div',{staticClass:"vdatetime-calendar__month__day",class:{'vdatetime-calendar__month__day--selected': day.selected, 'vdatetime-calendar__month__day--disabled': day.disabled},on:{"click":function($event){_vm.selectDay(day);}}},[_c('span',[_c('span',[_vm._v(_vm._s(day.number))])])])})],2)])},staticRenderFns: [],
  ...
  computed: {
    allowedDateTimeRangesFormatted: function allowedDateTimeRangesFormatted () {
    ...
    days: function days () {
      ...
      return monthDays(this.newYear, this.newMonth, this.weekStart).map(function (day) { return ({
        ...
        disabled: !day || monthDayIsDisabled(this$1.allowedDateTimeRangesFormatted, this$1.newYear, this$1.newMonth, day)
      }); })
    }
  },
...
var DatetimeTimePicker = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:{'vdatetime-time-picker': true, 'vdatetime-time-picker__with-suffix': _vm.use12Hour}},[_c('div',{ref:"hourList",staticClass:"vdatetime-time-picker__list vdatetime-time-picker__list--hours"},_vm._l((_vm.displayedHours),function(hour){return _c('div',{key:("hour-" + hour),staticClass:"vdatetime-time-picker__item",class:{'vdatetime-time-picker__item--selected': hour.selected, 'vdatetime-time-picker__item--disabled': hour.disabled},on:{"click":function($event){_vm.selectHour(hour);}}},[_vm._v(_vm._s(_vm.formatHour(hour.number)))])})),_vm._v(" "),_c('div',{ref:"minuteList",staticClass:"vdatetime-time-picker__list vdatetime-time-picker__list--minutes"},_vm._l((_vm.minutes),function(minute){return _c('div',{key:("hour-" + minute),staticClass:"vdatetime-time-picker__item",class:{'vdatetime-time-picker__item--selected': minute.selected, 'vdatetime-time-picker__item--disabled': minute.disabled},on:{"click":function($event){_vm.selectMinute(minute);}}},[_vm._v(_vm._s(minute.number))])})),_vm._v(" "),(_vm.use12Hour)?_c('div',{ref:"suffixList",staticClass:"vdatetime-time-picker__list vdatetime-time-picker__list--suffix"},_vm._l((_vm.timeSelections),function(timeSelection){return _c('div',{key:("selection-" + timeSelection),staticClass:"vdatetime-time-picker__item",class:{'vdatetime-time-picker__item--selected': timeSelection.comparison(_vm.hour) , 'vdatetime-time-picker__item--disabled': timeSelection.disabled },on:{"click":function($event){_vm.selectSuffix(timeSelection);}}},[_vm._v(_vm._s(timeSelection.id))])})):_vm._e()])},staticRenderFns: [],
  props: {
    hour: {
      type: Number,
      required: true
    ...
    currentDateTime: {
      type: luxon.DateTime,
      default: function () { return luxon.DateTime.utc(); }
    },
    allowedDateTimeRanges: {
      type: Array,
      default: function () { return []; }
  ...
  computed: {
    timeSelections: function timeSelections () {
      return this.use12Hour
        ? [
          {
            id: 'am',
            comparison: function (hour) { return hour < 12; },
    ...
    displayedHours: function displayedHours () {
      return this.hours.filter(function (hour) { return hour.display; })
    },
        ...
        .map(function (hour) {
          ...
          return {
            ...
            disabled: hourIsDisabled(
              this$1.allowedDateTimeRangesFormatted,
              this$1.currentDateTime,
              hour
            )
          }
        })
    ...
    minTimeFormatted: function minTimeFormatted () {
      return this.minTime ? luxon.DateTime.fromISO(this.minTime) : this.minTime
    },
    maxTimeFormatted: function maxTimeFormatted () {
      return this.maxTime ? luxon.DateTime.fromISO(this.maxTime) : this.maxTime
    },
    allowedDateTimeRangesFormatted: function allowedDateTimeRangesFormatted () {
  ...
  mounted: function mounted () {
    var hourListRef = this.$refs.hourList;
    var minuteListRef = this.$refs.minuteList;
    if (hourListRef) {
      var selectedHour = hourListRef
    ...
    if (minuteListRef) {
      var selectedMinute = minuteListRef
  ...
  computed: {
    ...
    years: function years$1 () {
      ...
      return years(this.year).map(function (year) { return ({
        ...
        disabled: !year || yearIsDisabled(this$1.allowedDateTimeRangesFormatted, year)
      }); })
    }
  },
  ...
  computed: {
    ...
    months: function months$1 () {
      ...
      return months(this.month).map(function (month, index) { return ({
        ...
        disabled: !index || monthIsDisabled(this$1.allowedDateTimeRangesFormatted, this$1.year, index)
      }); })
    }
  },
...
var DatetimePopup = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vdatetime-popup"},[_c('div',{staticClass:"vdatetime-popup__header"},[(_vm.title)?_c('div',{staticClass:"vdatetime-popup__title"},[_vm._v(_vm._s(_vm.title))]):_vm._e(),_vm._v(" "),(_vm.type !== 'time')?_c('div',{staticClass:"vdatetime-popup__year",on:{"click":_vm.showYear}},[_vm._v(_vm._s(_vm.year))]):_vm._e(),_vm._v(" "),(_vm.type !== 'time')?_c('div',{staticClass:"vdatetime-popup__date",on:{"click":_vm.showMonth}},[_vm._v(_vm._s(_vm.dateFormatted))]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"vdatetime-popup__body"},[(_vm.step === 'year')?_c('datetime-year-picker',{attrs:{"allowed-date-time-ranges":_vm.allowedDateTimeRangesFormatted,"year":_vm.year},on:{"change":_vm.onChangeYear}}):_vm._e(),_vm._v(" "),(_vm.step === 'month')?_c('datetime-month-picker',{attrs:{"allowed-date-time-ranges":_vm.allowedDateTimeRangesFormatted,"year":_vm.year,"month":_vm.month},on:{"change":_vm.onChangeMonth}}):_vm._e(),_vm._v(" "),(_vm.step === 'date')?_c('datetime-calendar',{attrs:{"year":_vm.year,"month":_vm.month,"day":_vm.day,"allowed-date-time-ranges":_vm.allowedDateTimeRangesFormatted,"week-start":_vm.weekStart},on:{"change":_vm.onChangeDate}}):_vm._e(),_vm._v(" "),(_vm.step === 'time')?_c('datetime-time-picker',{attrs:{"hour":_vm.hour,"minute":_vm.minute,"use12-hour":_vm.use12Hour,"hour-step":_vm.hourStep,"minute-step":_vm.minuteStep,"current-date-time":_vm.newDatetime,"allowed-date-time-ranges":_vm.allowedDateTimeRangesFormatted},on:{"change":_vm.onChangeTime}}):_vm._e()],1),_vm._v(" "),_c('div',{staticClass:"vdatetime-popup__actions"},[_c('div',{staticClass:"vdatetime-popup__actions__button vdatetime-popup__actions__button--cancel",on:{"click":_vm.cancel}},[_vm._t("button-cancel__internal",[_vm._v(_vm._s(_vm.phrases.cancel))],{step:_vm.step})],2),_vm._v(" "),_c('div',{staticClass:"vdatetime-popup__actions__button vdatetime-popup__actions__button--confirm",on:{"click":_vm.confirm}},[_vm._t("button-confirm__internal",[_vm._v(_vm._s(_vm.phrases.ok))],{step:_vm.step})],2)])])},staticRenderFns: [],
  components: {
