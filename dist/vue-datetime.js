...
function hourIsDisabled (allowedDateTimeRanges, currentDateTime, hour) {
  var startCheck = luxon.DateTime.fromObject({ year: currentDateTime.c.year, month: currentDateTime.c.month, day: currentDateTime.c.day, hour: hour, zone: 'UTC' });
...
function minuteIsDisabled (allowedDateTimeRanges, currentDateTime, hour, minute) {
  var startCheck = luxon.DateTime.fromObject({ year: currentDateTime.c.year, month: currentDateTime.c.month, day: currentDateTime.c.day, hour: hour, minute: minute, zone: 'UTC' });
  ...
  computed: {
    ...
    days: function days () {
      ...
      return monthDays(this.newYear, this.newMonth, this.weekStart).map(function (day) { return ({
        ...
        disabled: !day || monthDayIsDisabled(this$1.allowedDateTimeRanges, this$1.newYear, this$1.newMonth, day)
      }); })
    }
  },
  ...
  computed: {
    timeSelections: function timeSelections () {
      ...
      return this.use12Hour
        ? [{ id: 'am', comparison: function (hour) { return hour < 12; }, disabled: selectionIsDisabled(this.hours, this.use12Hour, 'am') },
          { id: 'pm', comparison: function (hour) { return hour >= 12; }, disabled: selectionIsDisabled(this.hours, this.use12Hour, 'pm') }]
        : []
    },
    hours: function hours$1 () {
      ...
      return hours(this.hourStep).filter(function (hour) {
        ...
        disabled: hourIsDisabled(this$1.allowedDateTimeRanges, this$1.currentDateTime, hour)
      }); })
    },
    minutes: function minutes$1 () {
      ...
      return minutes(this.minuteStep).map(function (minute) { return ({
        ...
        disabled: minuteIsDisabled(this$1.allowedDateTimeRanges, this$1.currentDateTime, this$1.hour, minute)
      }); })
    }
  },
  ...
  computed: {
    years: function years$1 () {
      ...
      return years(this.year).map(function (year) { return ({
        ...
        disabled: !year || yearIsDisabled(this$1.allowedDateTimeRanges, year)
      }); })
    }
  },
  ...
  computed: {
    months: function months$1 () {
      ...
      return months(this.month).map(function (month, index) { return ({
        ...
        disabled: !index || monthIsDisabled(this$1.allowedDateTimeRanges, this$1.year, index)
      }); })
    }
  },
...
var DatetimePopup = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vdatetime-popup"},[_c('div',{staticClass:"vdatetime-popup__header"},[(_vm.title)?_c('div',{staticClass:"vdatetime-popup__title"},[_vm._v(_vm._s(_vm.title))]):_vm._e(),_vm._v(" "),(_vm.type !== 'time')?_c('div',{staticClass:"vdatetime-popup__year",on:{"click":_vm.showYear}},[_vm._v(_vm._s(_vm.year))]):_vm._e(),_vm._v(" "),(_vm.type !== 'time')?_c('div',{staticClass:"vdatetime-popup__date",on:{"click":_vm.showMonth}},[_vm._v(_vm._s(_vm.dateFormatted))]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"vdatetime-popup__body"},[(_vm.step === 'year')?_c('datetime-year-picker',{attrs:{"allowed-date-time-ranges":_vm.allowedDateTimeRanges,"year":_vm.year},on:{"change":_vm.onChangeYear}}):_vm._e(),_vm._v(" "),(_vm.step === 'month')?_c('datetime-month-picker',{attrs:{"allowed-date-time-ranges":_vm.allowedDateTimeRanges,"year":_vm.year,"month":_vm.month},on:{"change":_vm.onChangeMonth}}):_vm._e(),_vm._v(" "),(_vm.step === 'date')?_c('datetime-calendar',{attrs:{"year":_vm.year,"month":_vm.month,"day":_vm.day,"allowed-date-time-ranges":_vm.allowedDateTimeRanges,"week-start":_vm.weekStart},on:{"change":_vm.onChangeDate}}):_vm._e(),_vm._v(" "),(_vm.step === 'time')?_c('datetime-time-picker',{attrs:{"hour":_vm.hour,"minute":_vm.minute,"use12-hour":_vm.use12Hour,"hour-step":_vm.hourStep,"minute-step":_vm.minuteStep,"current-date-time":_vm.newDatetime,"allowed-date-time-ranges":_vm.allowedDateTimeRanges},on:{"change":_vm.onChangeTime}}):_vm._e()],1),_vm._v(" "),_c('div',{staticClass:"vdatetime-popup__actions"},[_c('div',{staticClass:"vdatetime-popup__actions__button vdatetime-popup__actions__button--cancel",on:{"click":_vm.cancel}},[_vm._t("button-cancel__internal",[_vm._v(_vm._s(_vm.phrases.cancel))],{step:_vm.step})],2),_vm._v(" "),_c('div',{staticClass:"vdatetime-popup__actions__button vdatetime-popup__actions__button--confirm",on:{"click":_vm.confirm}},[_vm._t("button-confirm__internal",[_vm._v(_vm._s(_vm.phrases.ok))],{step:_vm.step})],2)])])},staticRenderFns: [],
  components: {
...
var Datetime = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vdatetime"},[_vm._t("before"),_vm._v(" "),_c('input',_vm._g(_vm._b({staticClass:"vdatetime-input",class:_vm.inputClass,style:(_vm.inputStyle),attrs:{"id":_vm.inputId,"type":"text"},domProps:{"value":_vm.inputValue},on:{"click":_vm.open,"focus":_vm.open}},'input',_vm.$attrs,false),_vm.$listeners)),_vm._v(" "),(_vm.hiddenName)?_c('input',{attrs:{"type":"hidden","name":_vm.hiddenName},domProps:{"value":_vm.value},on:{"input":_vm.setValue}}):_vm._e(),_vm._v(" "),_vm._t("after"),_vm._v(" "),_c('transition-group',{attrs:{"name":"vdatetime-fade","tag":"div"}},[(_vm.isOpen)?_c('div',{key:"overlay",staticClass:"vdatetime-overlay",on:{"click":function($event){if($event.target !== $event.currentTarget){ return null; }_vm.cancel($event);}}}):_vm._e(),_vm._v(" "),(_vm.isOpen)?_c('datetime-popup',{key:"popup",attrs:{"type":_vm.type,"datetime":_vm.popupDate,"phrases":_vm.phrases,"use12-hour":_vm.use12Hour,"hour-step":_vm.hourStep,"minute-step":_vm.minuteStep,"allowed-date-time-ranges":_vm.allowedDateTimeRangesFormatted,"auto":_vm.auto,"week-start":_vm.weekStart,"flow":_vm.flow,"title":_vm.title},on:{"confirm":_vm.confirm,"cancel":_vm.cancel,"change":_vm.change},scopedSlots:_vm._u([{key:"button-cancel__internal",fn:function(scope){return [_vm._t("button-cancel",[_vm._v(_vm._s(_vm.phrases.cancel))],{step:scope.step})]}},{key:"button-confirm__internal",fn:function(scope){return [_vm._t("button-confirm",[_vm._v(_vm._s(_vm.phrases.ok))],{step:scope.step})]}}])}):_vm._e()],1)],2)},staticRenderFns: [],
  ...
  computed: {
    ...
    allowedDateTimeRangesFormatted: function allowedDateTimeRangesFormatted () {
      var allowedDateTimeRanges = this.allowedDateTimeRanges;
  ...
  methods: {
    ...
    change: function change(datetime) {
